...
let UnitsController = class UnitsController {
    ...
    async create(dto) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.units.create(dto));
    }
    async update(id, dto) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.units.update(BigInt(id), dto));
    }
    async remove(id) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.units.remove(BigInt(id)));
    }
};
