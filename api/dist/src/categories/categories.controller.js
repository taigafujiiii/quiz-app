...
let CategoriesController = class CategoriesController {
    ...
    async create(dto) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.categories.create(dto));
    }
    async update(id, dto) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.categories.update(BigInt(id), dto));
    }
    async remove(id) {
        return (0, bigint_serializer_1.serializeBigInt)(await this.categories.remove(BigInt(id)));
    }
};
